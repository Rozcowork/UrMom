...
public class ChaserController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        TriggerGO = Trigger1.GetComponent<ChaserCheck>().CollEnter; // checks other script to know when to start moving
    }
    ...
    private void EnemyMovement() //Enemy movement to patrol points
    {
        ...
        else if (patrolDestination == 1 && TriggerGO == true) //if player at patrol destination 1
        {
